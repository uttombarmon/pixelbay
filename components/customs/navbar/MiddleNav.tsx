    ...
    <NavigationMenu viewport={false}>
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-2 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
              ...
              <ListItem href="/search?s=keyboard" title="Keyboards"></ListItem>
        ...
        <NavigationMenuItem className=" hidden xl:block">
          ...
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-2 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
              <ListItem href="/search?s=smart+tv" title="Smart TVs"></ListItem>
              <ListItem
              ...
              ></ListItem>
              <ListItem href="/search?s=soundbar" title="Soundbars"></ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
        {/* others  */}
